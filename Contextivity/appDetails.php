                ...
                <div id="myTabContent" class="tab-content">
                 ...
                 <div class="tab-pane fade beaconAnalytics" id="appAnalyticsPanelContent">
                  <div id="filterPanel">
                   ...
                   <div class="col-md-3">Beacon Name</div>
                   <div class="col-md-3">Beacon Location</div>
                   <div class="col-md-3">Beacon Message</div>
                   <div class="col-md-3">User Name</div>
                   <div class="col-md-3">User Session</div>
                   <div class="col-md-3">
                    <select tabindex="-1" name="select_beacon_name" class="select_beacon_name" id="select_beacon_name" data-selecter-options="{&quot;cover&quot;:&quot;true&quot;}">
                      ...
                      if ($stmt = $mysqli->prepare("SELECT beacon_name,beacon_uuid FROM registered_beacons
                        ...
                        while ($stmt->fetch()) 
                        {
                          echo '<option value='.$beacon_uuid.'>'.$beacon_name.'</option>';
                  ...
                  <div class="col-md-3">
                   <select tabindex="-1" name="select_beacon_location" class="select_beacon_location" id="select_beacon_location" data-selecter-options="{&quot;cover&quot;:&quot;true&quot;}">
                    <option value='All'>All</option>
                    <?php
                    if ($stmt = $mysqli->prepare("SELECT beacon_location FROM registered_beacons
                      WHERE beacon_app_id = ? GROUP BY(beacon_location)")) {
                        ...
                        while ($stmt->fetch()) 
                        {
                          echo '<option value='.$beacon_name.'>'.$beacon_name.'</option>';
                  ...
                  <div class="col-md-3">
                   <select tabindex="-1" name="select_beacon_broadcast_message" class="select_beacon_broadcast_message" id="select_beacon_broadcast_message" data-selecter-options="{&quot;cover&quot;:&quot;true&quot;}">
                    <option value='All'>All</option>
                    <?php
                  ...
                  <div class="col-md-3">
                   <select tabindex="-1" name="select_beacon_user_name" class="select_beacon_user_name" id="select_beacon_user_name" data-selecter-options="{&quot;cover&quot;:&quot;true&quot;}">
                    <option value='All'>All</option>
                    <?php
                    if ($stmt = $mysqli->prepare("SELECT user_name FROM beacon_analytics      
                     WHERE analytics_app_id = ? GROUP BY(user_name)")) {
                        ...
                        while ($stmt->fetch()) 
                        {
                          echo '<option value='.$analytics_user_name.'>'.$analytics_user_name.'</option>';
                  ...
                  <div class="col-md-3">
                   <select tabindex="-1" name="select_beacon_session_duration" class="select_beacon_session_duration" id="select_beacon_session_duration" data-selecter-options="{&quot;cover&quot;:&quot;true&quot;}">
                    <option value='All'>All</option>
                    <?php
                    if ($stmt = $mysqli->prepare("SELECT session_duration FROM beacon_analytics
                      WHERE analytics_app_id = ? GROUP BY(session_duration)")) {
                        ...
                        while ($stmt->fetch()) 
                        {
                          echo '<option value='.$session_time.'>'.$session_time.'</option>';
...
$('#user_name_list li a').on('click', function () {
  ...
  if($(this).text() == "All")
    ...
    queryString = "WHERE user_name = '"+ $(this).text() + "'";

  console.log(queryString);
  $.get("analyticsFetcher.php?q=" + queryString,function(data,status){
...
$('#beacon_name_list li a').on('click', function () {
 ...
 if($(this).text() == "All")
  ...
  queryString = "WHERE beacon_uuid = '"+ this.id + "'";
...
function setAnalyticsData(data)
{
  ...
  var analyticsHTMLData = "";
  for(var i in resultArray.results)
  {
    analyticsHTMLData+="<tr><td>"+resultArray.results[i].beacon_name+"</td>"+
    "<td>"+resultArray.results[i].beacon_manufacturer+"</td>"+
    "<td>"+resultArray.results[i].analytics_beacon_uuid+"</td>"+
    "<td>"+resultArray.results[i].beacon_major_value+"</td>"+
    "<td>"+resultArray.results[i].beacon_minor_value+"</td>"+
    "<td>"+resultArray.results[i].beacon_location+"</td>"+
    "<td>"+resultArray.results[i].beacon_broadcast_message+"</td>"+
    "<td>"+resultArray.results[i].analytics_user_id+"</td>"+
    "<td>"+resultArray.results[i].analytics_user_name+"</td>"+
    "<td>"+resultArray.results[i].session_start+"</td>"+
    "<td>"+resultArray.results[i].session_end+"</td>"+
    "<td>"+toHHMMSS(resultArray.results[i].session_time)+"</td></tr>";
  }
  $("#analyticsDataTableBody").html(analyticsHTMLData);
}    

$("#select_beacon_name").selecter({
  callback: select_beacon_nameCallback
});

$("#select_beacon_location").selecter({
  callback: select_beacon_nameCallback
});

$("#select_beacon_broadcast_message").selecter({
  callback: select_beacon_nameCallback
});

$("#select_beacon_user_name").selecter({
  callback: select_beacon_nameCallback
});

$("#select_beacon_session_duration").selecter({
  callback: select_beacon_nameCallback
});

function select_beacon_nameCallback(value, index) {
    ...
    if(value == "All")
      ...
      queryString = "WHERE beacon_uuid = '" + value + "'";
