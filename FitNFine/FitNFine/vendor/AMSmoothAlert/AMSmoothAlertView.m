...
- (UIView*) alertPopupView
{
    ...
    alertSquare.layer.cornerRadius = 4.f;
...
- (void) labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 200, 70)];
    _textLabel.center = CGPointMake(alertView.frame.size.width/2, 85);
...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    if (hasCancelButton) {
        ...
        _defaultButton.center = CGPointMake((alertView.frame.size.width/4)+3, 145);

        //cancel button
        _cancelButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 84, 30)];
        _cancelButton.center = CGPointMake((alertView.frame.size.width*3/4)-3, 145);
        ...
        _defaultButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 200, 30)];
        _defaultButton.center = CGPointMake(alertView.frame.size.width/2, 145);
    }
